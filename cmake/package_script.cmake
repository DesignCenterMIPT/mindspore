...
if(NOT (PYTHON_VERSION MATCHES "3.10" OR PYTHON_VERSION MATCHES "3.9" OR PYTHON_VERSION MATCHES "3.8" OR PYTHON_VERSION MATCHES "3.7"))
    message(FATAL_ERROR "FIND PYTHON VERSION ${PYTHON_VERSION} BUT CAN NOT MATCH PYTHON VERSION 3.10 OR 3.9 OR 3.8 OR 3.7")
endif()

# set package file name
if(CMAKE_SYSTEM_NAME MATCHES "Linux")
    if(PYTHON_VERSION MATCHES "3.10")
        if(CPACK_PYTHON_INTERPRETER_ID MATCHES "PyPy")
            set(PY_TAGS "pp310-pypy310_pp73")
        else()
            set(PY_TAGS "cp310-cp310")
        endif()
    elseif(PYTHON_VERSION MATCHES "3.9")
        if(CPACK_PYTHON_INTERPRETER_ID MATCHES "PyPy")
            set(PY_TAGS "pp39-pypy39_pp73")
        else()
