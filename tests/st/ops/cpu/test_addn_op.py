...
def test_addn_support_type():
    ...
    out_complex64 = ops.addn([Tensor(np.asarray(complex(1.5 + 0.4j)), mstype.complex64),
                              Tensor(np.asarray(complex(2.5 + 0.4j)), mstype.complex64)])
    out_complex128 = ops.addn([Tensor(np.asarray(complex(1.5 + 0.4j)), mstype.complex128),
                               Tensor(np.asarray(complex(2.5 + 0.4j)), mstype.complex128)])
    ...
    assert np.all(out_complex64.asnumpy() == Tensor(np.asarray(complex(4 + 0.8j)), mstype.complex64).asnumpy())
    assert np.all(out_complex128.asnumpy() == Tensor(np.asarray(complex(4 + 0.8j)), mstype.complex128).asnumpy())
